...
export const site = {
  name: "2ffjc",
  desc: "2ffjc的个人博客",
  url: "https://blog.2ffjc.com",
  avatar: "https://weavatar.com/avatar/d38ed17b8341a7eef9d44e15e7c3e029a93a0bcd1c34e9ff9bfa933d98ee278d?s=720",
  email: "3283739270@qq.com",
};
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，把内容复制修改后邮件中发送</p>
